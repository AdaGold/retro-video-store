"""adds a new customer and video model

Revision ID: a7dfee0230ad
Revises: 
Create Date: 2021-05-18 14:44:24.583862
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('video_id', 'total_inventory')
    )
